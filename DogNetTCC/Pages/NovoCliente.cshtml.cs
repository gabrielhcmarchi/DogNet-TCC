...
namespace DogNet.Views
{
    public class NovoClienteModel : PageModel
    {
        ...
        public NovoClienteModel(DogNetMvcContext context, IEmailSender emailSender,
